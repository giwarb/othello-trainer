...
- 開幕単位(n=15) 平均差(candidate-baseline): +1.7333石、95%CI[-2.3333, +6.0000]、符号検定p=0.4386
- 局単位(n=30) 平均差: +1.7333石、95%CI[-1.8000, +5.5333]、符号検定p=0.6831
- **1手あたりノード数(壁時計非依存、決定的な速度指標)**: baseline(t=1.5) 9570877 → candidate(t=1.0) 12060475 (-26.01%削減)
- 1手あたり時間(壁時計、参考値): baseline(t=1.5) 1741.3ms → candidate(t=1.0) 1835.0ms (-5.38%短縮)
- 1局あたり所要時間(壁時計、参考値): baseline 51.26s → candidate 53.52s (-4.42%短縮)
...
- 開幕単位平均差+1.7333石、CI上限+6.0000 → 大きな悪化なし(基準内)
